...
const projects = [
    {
        title: "Portfolio",
        description:
            "My personal portfolio built with Vue.js and TailwindCSS with a lot of micro-animations.",
    ...
    },
    {
        ...
        description:
            "Frontend work in Vue.js + TailwindCSS during my second-year internship.",
    ...
    },
    {
        ...
        description:
            "Website for a garage in Hengelo built with TailwindCSS & Laravel (backend in progress).",
    ...
    >
        ...
        >
          ...
          transition: { duration: 0.7, delay: 0.1, ease: 'easeOut' },
                ...
                class="mb-10 md:mb-14 text-center space-y-3"
            >
                <div
                ...
                <p class="text-sm sm:text-base text-white/60 max-w-xl mx-auto">
                    A mix of school projects, internship work and side projects – all
                    focused on clean UX, smooth interactions and solid code.
                </p>
            </div>
